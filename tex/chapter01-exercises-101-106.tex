              ...
              \item $\{w|w~\text{starts with an }a\text{ and has at most one }b\}$
                    ...
                    \begin{figure}[H]
                        ...
                        \begin{tikzpicture}
                            \node[state, initial] (q1) {};
                            \node[state, right of=q1, accepting] (q2) {};
                            \node[state, below of=q1, right of=q2 ] (q3) {};
                            \draw
                    ...
                    \begin{figure}[H]
                        ...
                        \begin{tikzpicture}[
                            ...
                            \node[state, right of=q12, styleSmall] (q13) {};
                            \node[state, below of=q11, styleSmall] (q21) {};
                            \node[state, right of=q21, styleSmall] (q22) {};
                            \node[state, right of=q22, styleSmall] (q23) {};
                            \node[state, below of=q21, styleSmall] (q31) {};
                            \node[state, right of=q31, styleSmall] (q32) {};
                            \node[state, right of=q32, styleSmall] (q33) {};
                            \draw
                            (q11) edge[left, left] node{$a$} (q21)
                            (q11) edge[left, above] node{$b$} (q32)
                            (q12) edge[left, left] node{$a$} (q22)
                            (q12) edge[left, above] node{$b$} (q33)
                            (q13) edge[left, left] node{$a$} (q23)
                            (q13) edge[bend left, right] node{$b$} (q33)

                            (q21) edge[loop below] node{$a$} (q21)
                            (q21) edge[left, above] node{$b$} (q22)
                            (q22) edge[loop below] node{$a$} (q22)
                            (q22) edge[left, above] node{$b$} (q23)
                            (q23) edge[loop below] node{$a,b$} (q23)

                            (q31) edge[loop below] node{$a$} (q31)
                            (q31) edge[left, above] node{$b$} (q32)
                            (q32) edge[loop below] node{$a$} (q32)
                            (q32) edge[left, above] node{$b$} (q33)
                            (q33) edge[loop below] node{$a,b$} (q33)
                            ;
                        \end{tikzpicture}
                    \end{figure}
