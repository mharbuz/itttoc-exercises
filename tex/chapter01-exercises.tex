    ...
    \item[1.5]
          ...
          \begin{enumerate}
              \item $A = \{w|w~\text{does not contain the substring }ab\}$
                    ...
                    $A^\complement = \{w|w~\text{contains the substring }ab\}$
                    \begin{figure}[H]
                        \centering
                        \begin{tikzpicture}
                        ...
                        \begin{tikzpicture}
                            ...
                            (q3) edge[loop above] node{$a,b$} (q3);
                        \end{tikzpicture}
                        \caption{$A^\complement$ and $A$}
                    \end{figure}
              \item $\{w|w~\text{does notcontain the substring }baba\}$
              \item $\{w|w~\text{contains neither the substrings }ab\text{ nor }ba\}$
              \item $\{w|w~\text{is any string not in }a^{\ast}b^{\ast}\}$
              \item $\{w|w~\text{is any string not in }(ab+)^{\ast}\}$
              \item $\{w|w~\text{is any string not in }a^{\ast} \cup b^{\ast}\}$
              \item $\{w|w~\text{is any string that doesn’t contain exactly two }a\text{’s}\}$
              \item $\{w|w~\text{is any string except }a\text{ and }b\}$
          \end{enumerate}
